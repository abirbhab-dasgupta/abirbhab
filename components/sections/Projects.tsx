  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        />
        <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-gradient-to-r from-orange-500/5 to-transparent rounded-full blur-3xl" />
        <div className="absolute bottom-1/3 left-1/4 w-64 h-64 bg-gradient-to-l from-orange-400/5 to-transparent rounded-full blur-2xl" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="flex justify-between items-center mb-8">
            <motion.button
              onClick={prevProject}
              className="group flex items-center justify-center w-12 h-12 bg-gradient-to-r from-orange-500/10 to-orange-600/10 backdrop-blur-sm border border-orange-400/30 rounded-full text-white/80 hover:text-white hover:border-orange-400/50 transition-all duration-300"
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {visibleProjects.map((project, index) => (
                  <ProjectCard key={`${project.id}-${currentIndex}-${index}`} project={project} index={index} />
                ))}
              </motion.div>
            </AnimatePresence>
          </div>
        ...
        >
          <motion.a
            ...
            className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-orange-500/10 to-orange-600/10 backdrop-blur-sm border border-orange-400/30 rounded-xl text-white/80 hover:text-white hover:border-orange-400/50 transition-all duration-300 group"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
...
function ProjectCard({ project, index }: { project: (typeof projects)[0]; index: number }) {
  return (
    ...
    >
      {/* Card Container */}
      <div className="relative bg-gradient-to-br from-orange-500/5 to-orange-600/10 backdrop-blur-sm border border-orange-400/20 rounded-2xl p-6 h-full overflow-hidden group-hover:border-orange-400/40 transition-all duration-500">
        {/* Decorative Elements */}
        ...
        <div className="absolute bottom-0 left-0 w-16 h-16 bg-orange-400/10 rounded-full blur-xl group-hover:bg-orange-400/20 transition-all duration-500" />
